...
2. DOM，Document Object Model
   ...
   * JS 可以透過 DOM 取得元素，並改變元素
     <img src="https://upload.wikimedia.org//wikipedia/commons/thumb/5/5a/DOM-model.svg/220px-DOM-model.svg.png" width="100%" height="100%" alt="DOM" align="center">
...
3. 事件傳遞機制: 捕獲與冒泡
   ...
   <img src="https://www.w3.org/TR/DOM-Level-3-Events/images/eventflow.svg" width="100%" height="300px" alt="event dispatch and DOM event flow" align=center>
